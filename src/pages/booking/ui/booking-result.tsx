          ...
          <CardContent className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div>
                  {data.booking_services.map((service, idx) => (
                    <React.Fragment key={idx}>
                      <div className="py-2.5 grid grid-cols-[48px_1fr_140px]">
                        ...
                        <div className="flex gap-2.5 items-center">
                          <Avatar size={"large"} id={service.service.service_id} name={service.service.name} avatar_url={service.service.avatar} />
                          <div>
                      ...
                      {idx !== data.booking_services.length - 1 && <div className="w-full h-px bg-border" />}
                    </React.Fragment>
                  ))}
                </div>
              ...
              <div className="flex items-center justify-between gap-2.5">
                ...
                <p className="font-bold">{formatPrice(data.order?.subtotal ? data.order.subtotal : data.booking_services.reduce((sum, s) => sum + s.booking_service_price, 0))} ₽</p>
              </div>
